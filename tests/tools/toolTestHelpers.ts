...
import type { ShimRegisteredTool, ToolRegistrar } from '../../src/tools/types.js';
...
export function collectTools(registerTools: (registrar: ToolRegistrar) => void) {
  const tools = new Map<string, RegisteredTool>();
  registerTools({
    registerTool(tool: ShimRegisteredTool) {
